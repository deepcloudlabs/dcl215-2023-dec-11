...
Kurulum Bilgisi:
========================================
Eğitimde lab çalışmaları için gerekli olan çalışma ortamının kurulumu için öncelikle aşağıdaki bağlantıda yer alan sıkıştırılmış dosyayı makinanıza indirmeniz gerekiyor: [https://www.deepcloudlabs.com/software/DEVEL-stage-2020a-java.se.and.spring.7z](https://courseware.deepcloudlabs.com/software/DEVEL-stage-2024a-java.se.zip)
